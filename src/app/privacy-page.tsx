...
function Privacy() {
    return (
        <section className='max-w-3xl mx-auto'>
            ...
            <div className="mb-6">
                <h3 className="text-2xl font-bold mb-2">1. Information We Collect</h3>
                <p className="mb-2">We may collect personal information from you when you fill out a form, subscribe to our newsletter, or interact with our website. This information may include your name, email address, phone number, and any other details you provide.</p>

            </div>

            <div className="mb-6">
                <h3 className="text-2xl font-bold mb-2">2. How We Use Your Information</h3>
            ...
            <div className="mb-6">
                <h3 className="text-2xl font-bold mb-2">3. Data Security</h3>
            ...
            <div className="mb-6">
                <h3 className="text-2xl font-bold mb-2">4. Sharing Your Information</h3>
            ...
            <div className="mb-6">
                ...
                <p>You have the right to request access to the personal information we hold about you, to request corrections, and to request deletion of your information.</p>
            </div>
