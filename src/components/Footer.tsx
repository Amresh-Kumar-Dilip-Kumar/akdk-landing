                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            ...
                            <li>
                                <a href="/project" className="hover:text-orange-400 transition-colors">Portfolio</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <a href="/contact-us" className="hover:text-orange-400 transition-colors">Contact</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <a href="/" className="hover:text-orange-400 transition-colors">Menu 1</a>
                            </li>
                        </ul>
                    </div>
